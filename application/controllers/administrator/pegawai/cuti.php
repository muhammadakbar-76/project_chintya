...
class cuti extends CI_Controller{
	...
	{		
		...
		$this->load->view('administrator/pegawai/cuti',$data);
	...
	public function input()
	{
		...
		$data['tb_notif'] = $this->notif_model->tampil_data()->result();
		$this->load->view('templates_administrator/sidebarpegawai',$data);
		$this->load->view('administrator/pegawai/cuti_tambah',$data);
		$this->load->view('templates_administrator/footer');
	}
	...
	public function update($id)
	{
		...
		$data['tb_notif'] = $this->notif_model->tampil_data()->result();
		$this->load->view('templates_administrator/sidebarpegawai',$data);
		$this->load->view('administrator/pegawai/cuti_update',$data);
		$this->load->view('templates_administrator/footer');
	...
	public function update_aksi()
	{
		...
		$verifikasi = $this->input->post('verifikasi');
			...
			redirect('administrator/pegawai/cuti');
		}
