                ...
                foreach ($tb_cuti as $pg) : ?>
                 <tr>
                      ...
                      <td class="project-actions text-left">                
                          <a width="20px"><?php echo anchor('administrator/user/cuti/update/'.$pg->id,'<div class="btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></div>') ?>
                        </a>
                          <a width="20px"><?php echo anchor('administrator/user/cuti/delete/'.$pg->id,'<div class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div>') ?>
                          </a>
                      </td>
                      </td>
                  </tr>
