...
<body>
    ...
    <hr class="line-title">
    <p align="center">
        <strong>LAPORAN DATA PEGAWAI</strong>
    </p>
    ...
    <table id="customers" class="table table-bordered">
        ...
        <tbody>
            ...
            foreach ($pegawai as $pg) : $tgl = date('d-m-Y', strtotime($pg->tgl_lahir_pegawai)); ?>
                <tr align="center">
                    <td width="20px"><?php echo $no++ ?></td>
                    <td><?php echo $pg->nik_pegawai ?></td>
                    <td><?php echo $pg->nama_pegawai ?></td>
                    <td><?php echo "$pg->tempat_lahir_pegawai, $tgl" ?></td>
                    <td><?php echo $pg->nama_jabatan ?></td>
                    <td><?php echo $pg->nama_divisi ?></td>
                    <td><?php echo $pg->gaji_jabatan ?></td>
                </tr>
