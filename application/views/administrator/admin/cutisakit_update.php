<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Cuti sakit</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url() ?>administrator/admin/dashboardadmin">Home</a></li>
              <li class="breadcrumb-item active">Update Cuti sakit</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">  
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
            <?php foreach($tb_cutisakit as $pg) : ?>
             <?php echo form_open_multipart('administrator/admin/cutisakit/update_aksi'); ?>
              ...
              <div class="form-group">
                <label for="inputStatus">file</label>
                <input type="text" name="file" value="<?php echo $pg->file?>" class="form-control" id="">
                <?php echo form_error('file','<div class="text-danger small" ml-3>') ?>
              </div>
              ...
              <?php echo anchor('administrator/admin/cutisakit','<div class="btn mb-5 btn-primary">Kembali</div>') ?> 
              <?php echo form_close(); ?>
            <?php endforeach;?>
    </div>
