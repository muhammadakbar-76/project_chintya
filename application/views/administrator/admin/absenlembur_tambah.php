...
<section class="content">
      ...
      <div class="row">  
        ...
        <div class="col-md-12">
           ...
           <?php echo form_open_multipart('administrator/admin/absenlembur/input_aksi'); ?>
          <div class="card card-primary">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" name="jam" class="form-control" id="jam" >
         ...
         <button type="submit" class="btn btn-primary mb-5">Simpan</button>
              <?php echo anchor('administrator/admin/absenlembur','<div class="btn mb-5 btn-primary">Kembali</div>') ?> 
              <?php echo form_close(); ?>
    </div>
